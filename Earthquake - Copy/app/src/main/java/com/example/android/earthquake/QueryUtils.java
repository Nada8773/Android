...
public final class QueryUtils {
    ...
    public static List<word> fetchEarthquakeData(String requestUrl) {
        ...
        // The Background sleep for 2 sec
        try {
            Thread.sleep(2000);
    ...
    private static List<word> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++)
            {
                ...
                word w = new word(magnitude, location, date,url);
                al.add(w);
            }
...
/*   // this code if we take our data from variable never  change
public final class QueryUtils {
...
/**
     ...
     * <p>
     * static final := value will never change
     *//*
    ...
    */
/**
     * private constructor means no one can create instance from this class
     *//*
